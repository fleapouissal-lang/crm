...
export const DARIJA_GLOSSARY: Array<{ term: string; meaning: string }> = [
  ...
  { term: "chno / ach / ash", meaning: "quoi / qu'est-ce que — répondre à la question, pas pitcher" },
  { term: "wach / wash", meaning: "est-ce que — réponse courte oui/non + précision" },
  { term: "bghit / bghiti / bghito", meaning: "je veux / tu veux — besoin client" },
  { term: "tqado / nqado", meaning: "régler / mettre en place / résoudre" },
  { term: "barra / kaml", meaning: "à l'étranger / partout / en entier" },
