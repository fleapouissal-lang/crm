    ...
    messages: [
      ...history.slice(-20),
      {
        ...
        content: [
          ...
          "",
          "RÈGLES RÉPONSE:",
          "- UN seul message WhatsApp court (2 phrases + 1 question max).",
          "- Une seule langue cohérente (darija latin OU français) — pas de franglais maladroit ni emoji « Ah d'accord 😊 ».",
          "- « ste / sté / cest » = « c'est ». Ne JAMAIS inventer une entreprise « STE ».",
          "- Ne répète pas tout le pitch Evana/Autolog à chaque message. Réponds à LA question posée.",
          "- Si le prospect écrit en darija latin (fin kaynin, wach, chno, ste…) → réponds en darija latin naturel.",
