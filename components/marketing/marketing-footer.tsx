...
function SocialIcon({ name }: { name: "linkedin" | "twitter" | "instagram" | "mail" }) {
  if (name === "mail") {
...
const SOCIAL = [
  ...
  { href: "mailto:contact@fusionleap.com", label: "Email", icon: "mail" as const },
];
    ...
    <footer className="marketing-footer">
      <div className="marketing-footer__inner">
        <div className="marketing-footer__top">
          <Link href="/pricing" className="marketing-footer__logo">
            <LoginBrandLogo variant="plain" className="marketing-footer__logo-img" />
          </Link>
            ...
            {NAV.map(({ href, key }) => (
              <Link
                ...
                className={cn(
                  ...
                  pathname === href && "marketing-footer__nav-link--active"
                )}
              >
                {m.nav[key]}
              </Link>
          ...
          <div className="marketing-footer__social">
            {SOCIAL.map(({ href, label, icon }) => (
              <a
                key={label}
                href={href}
                className="marketing-footer__social-btn"
                aria-label={label}
        ...
        <div className="marketing-footer__divider" aria-hidden />

        <p className="marketing-footer__copy">
          © {new Date().getFullYear()} Fusion Leap. {m.footer.rights}
        </p>
      </div>
    </footer>
  );
